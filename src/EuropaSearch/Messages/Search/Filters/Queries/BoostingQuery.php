...
/**
 * @file
 * Contains EC\EuropaSearch\Messages\Search\Filters\Queries\BoostingQuery.
 */
 ...
 */
class BoostingQuery extends BoostableFilter implements FilterQueryInterface
{
    ...
    {
        return BasicProxyController::COMPONENT_ID_PREFIX.'searching.filters.queries.boostingQuery';
    }
