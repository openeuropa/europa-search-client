...
class DocumentMetadataTest extends AbstractTest
{
    ...
    {
        $documentMetadata = new DocumentMetadata('title', 'This is the content type', 'string');
    ...
    {
        $documentMetadata = new DocumentMetadata('tested_date', '30-12-2018', 'date');
    ...
    public function testDocumentMetadataValidationFailure()
    {
        ...
        $documentMetadata = new DocumentMetadata(null, null, 123);
