...
class IndexWebContentTransporterTest extends AbstractEuropaSearchTest
{
    ...
    public function testSendIndexWebContentSuccess()
    {
        ...
        $expectedTarget = '/es/ingestion-api/rest/ingestion/text?apiKey=a221108a-180d-HTTP-INDEXING-TEST&database=OPENEUROPA-DUMMY-INDEXING&reference=web_content_1&uri=http%3A%2F%2Feuropa.test.com%2Fcontent.html&language=fr';
